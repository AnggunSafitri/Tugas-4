        ...
        <div class="col-md-12">
          <div class="aa-product-details-area">
                  ...
                  <div class="aa-product-view-slider">
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a data-lens-image="{{url('public')}}/img/view-slider/large/polo-shirt-1.png" class="simpleLens-lens-image"><img src="{{url('public')}}/img/view-slider/medium/polo-shirt-1.png" class="simpleLens-big-image"></a></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-price-block">
                      <span class="aa-product-view-price">Rp 10.000</span>
            ...
            <div class="aa-product-details-bottom">
              ...
              <div class="tab-content">
                <div class="tab-pane fade in active" id="description">
                  <p>Cara Order : Kakak hanya perlu pilih warna yang kakak mau, lalu kakak masukkan ke dalam keranjang, selanjutnya kakak keluar lagi dan pilih warna lain lagi sesuai keinginan, dan begitulah seterusnya. Kalau sudah pas dengan warna pilihan kaka, kakak boleh tekan checout untuk melakukan pembayaran. Pembayaran yang kakak lakukan dapat melalui cara-cara yang telah disediakan oleh pihak Daily Shop ya kakak. Semoga produk kami menarik untuk kakak dan happy shopping, ditunggu pesanannya kakak :)</p>
                  <ul>
                    <li>Produk Impor 100%</li>
                    <li>Ready Stok dan dikirim dalam waktu 24 jam!</li>
                    <li>Dropship/Reseller/Wholesale are welcome</li>
                    <li>Ikuti kami untuk info DISKON dan BARANG BARU!</li>
                    <li>Resi terima yang asli tersedia logo toko kami</li>
                  </ul>
                  <p>Cek dahulu sebelum memesan, kami tidak akan terima pergantian Nama, Nomor, Alamat, atau Barang setelah diorder.</p>
                  <p>Dimohon untuk tidak mengcancel atau membatalkan pesanan yang telah dibuat atau kakak kami blacklist.</p>
                </div>
                <div class="tab-pane fade " id="review">
                  <div class="aa-product-review-area">
                    <h4>2 Penilaian Untuk Produk Kaos Kaki</h4>
                    <ul class="aa-review-nav">
                      <li>
                        <div class="media">
                          <div class="media-left">
                            <a href="#">
                              <img class="media-object" src="{{url('public')}}/img/testimonial-img-3.jpg" alt="girl image">
                            </a>
                          </div>
                          <div class="media-body">
                            <h4 class="media-heading"><strong>Michelle Ziudith</strong> - <span>10 AGUSTUS 2022</span></h4>
                            ...
                            <p>Bahan kaos kaki yang enak dipakai dengan kualitas baik.</p>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="media">
                          <div class="media-left">
                            <a href="#">
                              <img class="media-object" src="{{url('public')}}/img/testimonial-img-1.jpg" alt="girl image">
                            </a>
                          </div>
                          <div class="media-body">
                            <h4 class="media-heading"><strong>Jefri Nichol</strong> - <span>14 AGUSTUS 2022</span></h4>
                            <div class="aa-product-rating">
                              <span class="fa fa-star"></span>
                              <span class="fa fa-star"></span>
                              <span class="fa fa-star"></span>
                            ...
                            <p>Pengemasan produk baik, kaos kaki nyaman digunakan. Hanya saja saya sebagai laki-laki hanya cocok untuk beberapa model yang tersedia disini, salah satunya kaos kaki planet.</p>
                          </div>
                        </div>
                      </li>
                    </ul>
                    ...
                    <form action="" class="aa-review-form">
                      <div class="form-group">
                        <label for="message">Penilaian terhadap produk</label>
            ...
            <div class="aa-product-related-item">
              ...
              <ul class="aa-product-catg aa-related-item">
                ...
                <li>
                  <figure>
                    ...
                    <figcaption>
                      ...
                      <span class="aa-product-price">Rp 5.000</span><span class="aa-product-price"><del>Rp 6.000</del></span>
                    </figcaption>
                  </figure>
                  <div class="aa-product-hvr-content">
                    <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><span class="fa fa-heart-o"></span></a>
                  ...
                  <div class="modal-content">
                    <div class="modal-body">
                      ...
                      <div class="row">
                          ...
                          <div class="aa-product-view-slider">
                            <div class="simpleLens-gallery-container" id="demo-1">
                              ...
                              <div class="simpleLens-thumbnails-container">
                                <a href="#" class="simpleLens-thumbnail-wrapper" data-lens-image="{{url('public')}}/img/view-slider/large/polo-shirt-1.png" data-big-image="{{url('public')}}/img/view-slider/medium/polo-shirt-1.png">
                                  <img src="{{url('public')}}/img/view-slider/thumbnail/polo-shirt-1.png">
                                </a>
                                <a href="#" class="simpleLens-thumbnail-wrapper" data-lens-image="{{url('public')}}/img/view-slider/large/polo-shirt-3.png" data-big-image="{{url('public')}}/img/view-slider/medium/polo-shirt-3.png">
                                  <img src="{{url('public')}}/img/view-slider/thumbnail/polo-shirt-3.png">
                                </a>

                                <a href="#" class="simpleLens-thumbnail-wrapper" data-lens-image="{{url('public')}}/img/view-slider/large/polo-shirt-4.png" data-big-image="{{url('public')}}/img/view-slider/medium/polo-shirt-4.png">
                                  <img src="{{url('public')}}/img/view-slider/thumbnail/polo-shirt-4.png">
                                </a>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="aa-product-view-content">
                            <h3>Kaos Kaki Lembut Kucing</h3>
                            <div class="aa-price-block">
                              <span class="aa-product-view-price">Rp 15.000</span>
                              <p class="aa-product-avilability">Status Barang: <span>Tersedia</span></p>
                            </div>
                            <p>Kaos kaki dengan desain yang elegan, bahan yang pastinya sangat lembut. Didukung juga dengan desan yang akan mempercantik penampilan anda pada bagian kaki karena di kaos kaki ini terdapat gambar kucing yang imut.</p>
                            <p class="aa-prod-category">
                              kategori: <a href="#">Kaos Kaki Panjang</a>
                            </p>
                          </div>
                          <div class="aa-prod-view-bottom">
